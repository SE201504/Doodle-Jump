...
Rectangle {
    ...
    Row {
        ...
        height: Math.max(appImg.height, descriptionText.height) + dp(
                    Theme.navigationBar.defaultBarItemPadding)
        clip: true
        ...
        Column {
            ...
            Item {
                height: dp(Theme.navigationBar.defaultBarItemPadding) - parent.spacing
                width: parent.width
            } // spacer
            AppText {
                id: headerTxt
