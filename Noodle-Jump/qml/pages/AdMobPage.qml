...
ListPage {
    ...
    model: ListModel {
        ...
        ListElement {
            section: "Banner Type"
            current: false
            name: "Leaderboard (728x90) - Tablet Only"
        }
        ListElement {
            section: "Banner Type"
            current: true
            name: "Smart (auto-size)"
        }
    ...
    delegate: SimpleRow {
        ...
        text: name
        property bool isSelected: current || (index === 0 && adMobBanner.visible
                                              || index === 1
                                              && !adMobBanner.visible)
        ...
        onSelected: {
            ...
            if (index >= 2 && index <= 6) {
                for (var i = 0; i < listModel.count; i++) {
                    listModel.setProperty(i, "current",
                                          i === index ? true : false)
                }
            }
